...
static_lineChart <- function(data, xaxisPadding = 11, label.font = "Open Sans Condensed") {
...
for (lang in colnames(txt)) {
  ...
  dd$tooltip <- paste0("<b>", as.character(dd$country), "</b><br>",
              ...
              txt["tooltip.le", lang], " ", dd$last, " ", txt["tooltip.2", lang], 
              " ", maxYear, ", ",
              "+", dd$pc, "%  ", txt["tooltip.3", lang], " ", minYear, "</span></div>")
  
  chart <- static_lineChart(dd, label.font = "Open Sans")
}
...
dd$tooltip <- paste0("<b>", as.character(dd$country), "</b><br>",
              '<div><span style="font-size: 0.8em">',
              "Life expectancy ", dd$last, " years in ", maxYear, ", ",
              "+", dd$pc, "% since ", minYear, "</span></div>")
