...
data$probEqOrLess <- data$probEqOrLess * 100
 ...
 a <- Highcharts$new()
  ...
  a$tooltip(
    ...
    headerFormat =  'Age: <larger><b>{point.key}</larger></b> ans<table>',        
    pointFormat = '<tr><td style="color: {series.color}">{series.name}: </td> <td style="text-align: right"><b>{point.probEqOrLess: .1f}</b>% ont cet âge ou moins</td></tr>')
  a
